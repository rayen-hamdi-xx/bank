    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='bank_account_transaction_management.client')),
            ],
            options={
                'db_table': 'accounts',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bank_account_transaction_management.account')),
            ],
            options={
